  ...
  return (
    <>
      ...
      <p style={{ color: "#525252", fontStyle: "italic", maxWidth: 680 }}>
        Public feedback and discussion. Forums are moderated; do not post personally identifiable information.
      </p>

      <div className="card">
        <h3 style={{ marginTop: 0 }}>Post to a forum</h3>
        <form onSubmit={post}>
      ...
      <div className="card" style={{ padding: 0 }}>
        ...
        {list.length === 0 && <p style={{ padding: "1.5rem", color: "#525252", fontStyle: "italic", textAlign: "center" }}>No posts yet.</p>}
      </div>
    </>
  );
}
